...
vizanti_msgs__srv__Launches_Request__create()
{
  ...
  vizanti_msgs__srv__Launches_Request * msg = (vizanti_msgs__srv__Launches_Request *)allocator.allocate(sizeof(vizanti_msgs__srv__Launches_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vizanti_msgs__srv__Launches_Request));
  bool success = vizanti_msgs__srv__Launches_Request__init(msg);
  if (!success) {
...
vizanti_msgs__srv__Launches_Request__destroy(vizanti_msgs__srv__Launches_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    vizanti_msgs__srv__Launches_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
vizanti_msgs__srv__Launches_Request__Sequence__init(vizanti_msgs__srv__Launches_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vizanti_msgs__srv__Launches_Request * data = NULL;

  if (size) {
    data = (vizanti_msgs__srv__Launches_Request *)allocator.zero_allocate(size, sizeof(vizanti_msgs__srv__Launches_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vizanti_msgs__srv__Launches_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        vizanti_msgs__srv__Launches_Request__fini(&data[i - 1]);
      }
...
vizanti_msgs__srv__Launches_Request__Sequence__fini(vizanti_msgs__srv__Launches_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      vizanti_msgs__srv__Launches_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vizanti_msgs__srv__Launches_Request__Sequence * array = (vizanti_msgs__srv__Launches_Request__Sequence *)allocator.allocate(sizeof(vizanti_msgs__srv__Launches_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vizanti_msgs__srv__Launches_Request__Sequence__init(array, size);
  if (!success) {
...
vizanti_msgs__srv__Launches_Request__Sequence__destroy(vizanti_msgs__srv__Launches_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vizanti_msgs__srv__Launches_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vizanti_msgs__srv__Launches_Request__Sequence__are_equal(const vizanti_msgs__srv__Launches_Request__Sequence * lhs, const vizanti_msgs__srv__Launches_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vizanti_msgs__srv__Launches_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vizanti_msgs__srv__Launches_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vizanti_msgs__srv__Launches_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vizanti_msgs__srv__Launches_Request * data =
      (vizanti_msgs__srv__Launches_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vizanti_msgs__srv__Launches_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vizanti_msgs__srv__Launches_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!vizanti_msgs__srv__Launches_Request__copy(
...
vizanti_msgs__srv__Launches_Response__init(vizanti_msgs__srv__Launches_Response * msg)
{
  ...
  // launches
  if (!rosidl_runtime_c__String__Sequence__init(&msg->launches, 0)) {
    vizanti_msgs__srv__Launches_Response__fini(msg);
    return false;
  }
  return true;
}
...
vizanti_msgs__srv__Launches_Response__fini(vizanti_msgs__srv__Launches_Response * msg)
{
  ...
  // launches
  rosidl_runtime_c__String__Sequence__fini(&msg->launches);
}
  ...
  vizanti_msgs__srv__Launches_Response * output)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__copy(
      &(input->launches), &(output->launches)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vizanti_msgs__srv__Launches_Response * msg = (vizanti_msgs__srv__Launches_Response *)allocator.allocate(sizeof(vizanti_msgs__srv__Launches_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(vizanti_msgs__srv__Launches_Response));
  bool success = vizanti_msgs__srv__Launches_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
vizanti_msgs__srv__Launches_Response__Sequence__init(vizanti_msgs__srv__Launches_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vizanti_msgs__srv__Launches_Response * data = NULL;

  if (size) {
    data = (vizanti_msgs__srv__Launches_Response *)allocator.zero_allocate(size, sizeof(vizanti_msgs__srv__Launches_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = vizanti_msgs__srv__Launches_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        vizanti_msgs__srv__Launches_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
vizanti_msgs__srv__Launches_Response__Sequence__fini(vizanti_msgs__srv__Launches_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      vizanti_msgs__srv__Launches_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  vizanti_msgs__srv__Launches_Response__Sequence * array = (vizanti_msgs__srv__Launches_Response__Sequence *)allocator.allocate(sizeof(vizanti_msgs__srv__Launches_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = vizanti_msgs__srv__Launches_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
vizanti_msgs__srv__Launches_Response__Sequence__destroy(vizanti_msgs__srv__Launches_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    vizanti_msgs__srv__Launches_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
vizanti_msgs__srv__Launches_Response__Sequence__are_equal(const vizanti_msgs__srv__Launches_Response__Sequence * lhs, const vizanti_msgs__srv__Launches_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!vizanti_msgs__srv__Launches_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  vizanti_msgs__srv__Launches_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(vizanti_msgs__srv__Launches_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    vizanti_msgs__srv__Launches_Response * data =
      (vizanti_msgs__srv__Launches_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!vizanti_msgs__srv__Launches_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          vizanti_msgs__srv__Launches_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!vizanti_msgs__srv__Launches_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
