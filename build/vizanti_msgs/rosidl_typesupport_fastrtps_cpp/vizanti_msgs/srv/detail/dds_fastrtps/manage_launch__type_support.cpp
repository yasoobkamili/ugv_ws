...
#include "vizanti_msgs/srv/detail/manage_launch__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vizanti_msgs::srv::ManageLaunch_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vizanti_msgs::srv::ManageLaunch_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vizanti_msgs::srv::ManageLaunch_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ManageLaunch_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vizanti_msgs::srv::ManageLaunch_Request *>(
...
static size_t _ManageLaunch_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ManageLaunch_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ManageLaunch_Request__callbacks = {
  "vizanti_msgs::srv",
...
static rosidl_message_type_support_t _ManageLaunch_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ManageLaunch_Request__callbacks,
...
{
  return &vizanti_msgs::srv::typesupport_fastrtps_cpp::_ManageLaunch_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = vizanti_msgs::srv::ManageLaunch_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vizanti_msgs::srv::ManageLaunch_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<vizanti_msgs::srv::ManageLaunch_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ManageLaunch_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vizanti_msgs::srv::ManageLaunch_Response *>(
...
static size_t _ManageLaunch_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ManageLaunch_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ManageLaunch_Response__callbacks = {
  "vizanti_msgs::srv",
...
static rosidl_message_type_support_t _ManageLaunch_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ManageLaunch_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &vizanti_msgs::srv::typesupport_fastrtps_cpp::_ManageLaunch_Response__handle;
}
...
static service_type_support_callbacks_t _ManageLaunch__callbacks = {
  "vizanti_msgs::srv",
  "ManageLaunch",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, ManageLaunch_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vizanti_msgs, srv, ManageLaunch_Response)(),
...
static rosidl_service_type_support_t _ManageLaunch__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ManageLaunch__callbacks,
...
{
  return &vizanti_msgs::srv::typesupport_fastrtps_cpp::_ManageLaunch__handle;
}
