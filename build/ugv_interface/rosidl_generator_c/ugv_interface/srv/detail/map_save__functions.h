...
#ifndef UGV_INTERFACE__SRV__DETAIL__MAP_SAVE__FUNCTIONS_H_
#define UGV_INTERFACE__SRV__DETAIL__MAP_SAVE__FUNCTIONS_H_
...
/// Initialize srv/MapSave message.
/**
...
/// Create srv/MapSave message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ugv_interface__srv__MapSave_Request__init().
...
/// Destroy srv/MapSave message.
/**
 * It calls
 * ugv_interface__srv__MapSave_Request__fini()
...
/// Check for srv/MapSave message equality.
/**
...
/// Initialize array of srv/MapSave messages.
/**
...
/// Finalize array of srv/MapSave messages.
/**
 * It calls
 * ugv_interface__srv__MapSave_Request__fini()
...
/// Create array of srv/MapSave messages.
/**
 * It allocates the memory for the array and calls
 * ugv_interface__srv__MapSave_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MapSave messages.
/**
 * It calls
 * ugv_interface__srv__MapSave_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MapSave message array equality.
/**
...
/// Copy an array of srv/MapSave messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ugv_interface__srv__MapSave_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ugv_interface
...
/**
 * It calls
 * ugv_interface__srv__MapSave_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ugv_interface
...
/**
 * It allocates the memory for the array and calls
 * ugv_interface__srv__MapSave_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ugv_interface
...
/**
 * It calls
 * ugv_interface__srv__MapSave_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UGV_INTERFACE__SRV__DETAIL__MAP_SAVE__FUNCTIONS_H_
