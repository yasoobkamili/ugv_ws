...
ugv_interface__action__Behavior_Goal__init(ugv_interface__action__Behavior_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->command)) {
    ugv_interface__action__Behavior_Goal__fini(msg);
    return false;
  }
  return true;
}
...
ugv_interface__action__Behavior_Goal__create()
{
  ...
  ugv_interface__action__Behavior_Goal * msg = (ugv_interface__action__Behavior_Goal *)allocator.allocate(sizeof(ugv_interface__action__Behavior_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_Goal));
  bool success = ugv_interface__action__Behavior_Goal__init(msg);
  if (!success) {
...
ugv_interface__action__Behavior_Goal__Sequence__init(ugv_interface__action__Behavior_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Goal * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_Goal *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_Goal__fini(&data[i - 1]);
      }
...
ugv_interface__action__Behavior_Goal__Sequence__fini(ugv_interface__action__Behavior_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Goal__Sequence * array = (ugv_interface__action__Behavior_Goal__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_Goal__Sequence__init(array, size);
  if (!success) {
...
ugv_interface__action__Behavior_Goal__Sequence__destroy(ugv_interface__action__Behavior_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_Goal__Sequence__are_equal(const ugv_interface__action__Behavior_Goal__Sequence * lhs, const ugv_interface__action__Behavior_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_Goal * data =
      (ugv_interface__action__Behavior_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Result * msg = (ugv_interface__action__Behavior_Result *)allocator.allocate(sizeof(ugv_interface__action__Behavior_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_Result));
  bool success = ugv_interface__action__Behavior_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_Result__destroy(ugv_interface__action__Behavior_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ugv_interface__action__Behavior_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ugv_interface__action__Behavior_Result__Sequence__init(ugv_interface__action__Behavior_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Result * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_Result *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_Result__Sequence__fini(ugv_interface__action__Behavior_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Result__Sequence * array = (ugv_interface__action__Behavior_Result__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_Result__Sequence__destroy(ugv_interface__action__Behavior_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_Result__Sequence__are_equal(const ugv_interface__action__Behavior_Result__Sequence * lhs, const ugv_interface__action__Behavior_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_Result * data =
      (ugv_interface__action__Behavior_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Feedback * msg = (ugv_interface__action__Behavior_Feedback *)allocator.allocate(sizeof(ugv_interface__action__Behavior_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_Feedback));
  bool success = ugv_interface__action__Behavior_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_Feedback__destroy(ugv_interface__action__Behavior_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ugv_interface__action__Behavior_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ugv_interface__action__Behavior_Feedback__Sequence__init(ugv_interface__action__Behavior_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Feedback * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_Feedback *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_Feedback__Sequence__fini(ugv_interface__action__Behavior_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_Feedback__Sequence * array = (ugv_interface__action__Behavior_Feedback__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_Feedback__Sequence__destroy(ugv_interface__action__Behavior_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_Feedback__Sequence__are_equal(const ugv_interface__action__Behavior_Feedback__Sequence * lhs, const ugv_interface__action__Behavior_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_Feedback * data =
      (ugv_interface__action__Behavior_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ugv_interface__action__Behavior_SendGoal_Request__init(ugv_interface__action__Behavior_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ugv_interface__action__Behavior_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!ugv_interface__action__Behavior_Goal__init(&msg->goal)) {
    ugv_interface__action__Behavior_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
ugv_interface__action__Behavior_SendGoal_Request__fini(ugv_interface__action__Behavior_SendGoal_Request * msg)
{
  ...
  // goal
  ugv_interface__action__Behavior_Goal__fini(&msg->goal);
}
...
ugv_interface__action__Behavior_SendGoal_Request__are_equal(const ugv_interface__action__Behavior_SendGoal_Request * lhs, const ugv_interface__action__Behavior_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!ugv_interface__action__Behavior_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_SendGoal_Request * msg = (ugv_interface__action__Behavior_SendGoal_Request *)allocator.allocate(sizeof(ugv_interface__action__Behavior_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_SendGoal_Request));
  bool success = ugv_interface__action__Behavior_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_SendGoal_Request__Sequence__init(ugv_interface__action__Behavior_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_SendGoal_Request * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_SendGoal_Request *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_SendGoal_Request__Sequence__fini(ugv_interface__action__Behavior_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_SendGoal_Request__Sequence * array = (ugv_interface__action__Behavior_SendGoal_Request__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_SendGoal_Request__Sequence__destroy(ugv_interface__action__Behavior_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_SendGoal_Request__Sequence__are_equal(const ugv_interface__action__Behavior_SendGoal_Request__Sequence * lhs, const ugv_interface__action__Behavior_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_SendGoal_Request * data =
      (ugv_interface__action__Behavior_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ugv_interface__action__Behavior_SendGoal_Response__init(ugv_interface__action__Behavior_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    ugv_interface__action__Behavior_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_SendGoal_Response * msg = (ugv_interface__action__Behavior_SendGoal_Response *)allocator.allocate(sizeof(ugv_interface__action__Behavior_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_SendGoal_Response));
  bool success = ugv_interface__action__Behavior_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_SendGoal_Response__Sequence__init(ugv_interface__action__Behavior_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_SendGoal_Response * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_SendGoal_Response *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_SendGoal_Response__Sequence__fini(ugv_interface__action__Behavior_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_SendGoal_Response__Sequence * array = (ugv_interface__action__Behavior_SendGoal_Response__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_SendGoal_Response__Sequence__destroy(ugv_interface__action__Behavior_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_SendGoal_Response__Sequence__are_equal(const ugv_interface__action__Behavior_SendGoal_Response__Sequence * lhs, const ugv_interface__action__Behavior_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_SendGoal_Response * data =
      (ugv_interface__action__Behavior_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ugv_interface__action__Behavior_GetResult_Request__init(ugv_interface__action__Behavior_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ugv_interface__action__Behavior_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_GetResult_Request * msg = (ugv_interface__action__Behavior_GetResult_Request *)allocator.allocate(sizeof(ugv_interface__action__Behavior_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_GetResult_Request));
  bool success = ugv_interface__action__Behavior_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_GetResult_Request__Sequence__init(ugv_interface__action__Behavior_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_GetResult_Request * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_GetResult_Request *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_GetResult_Request__Sequence__fini(ugv_interface__action__Behavior_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_GetResult_Request__Sequence * array = (ugv_interface__action__Behavior_GetResult_Request__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_GetResult_Request__Sequence__destroy(ugv_interface__action__Behavior_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_GetResult_Request__Sequence__are_equal(const ugv_interface__action__Behavior_GetResult_Request__Sequence * lhs, const ugv_interface__action__Behavior_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_GetResult_Request * data =
      (ugv_interface__action__Behavior_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ugv_interface__action__Behavior_GetResult_Response__init(ugv_interface__action__Behavior_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!ugv_interface__action__Behavior_Result__init(&msg->result)) {
    ugv_interface__action__Behavior_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
ugv_interface__action__Behavior_GetResult_Response__fini(ugv_interface__action__Behavior_GetResult_Response * msg)
{
  ...
  // status
  // result
  ugv_interface__action__Behavior_Result__fini(&msg->result);
}
...
ugv_interface__action__Behavior_GetResult_Response__are_equal(const ugv_interface__action__Behavior_GetResult_Response * lhs, const ugv_interface__action__Behavior_GetResult_Response * rhs)
{
  ...
  // result
  if (!ugv_interface__action__Behavior_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_GetResult_Response * msg = (ugv_interface__action__Behavior_GetResult_Response *)allocator.allocate(sizeof(ugv_interface__action__Behavior_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_GetResult_Response));
  bool success = ugv_interface__action__Behavior_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_GetResult_Response__Sequence__init(ugv_interface__action__Behavior_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_GetResult_Response * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_GetResult_Response *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_GetResult_Response__Sequence__fini(ugv_interface__action__Behavior_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_GetResult_Response__Sequence * array = (ugv_interface__action__Behavior_GetResult_Response__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_GetResult_Response__Sequence__destroy(ugv_interface__action__Behavior_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_GetResult_Response__Sequence__are_equal(const ugv_interface__action__Behavior_GetResult_Response__Sequence * lhs, const ugv_interface__action__Behavior_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_GetResult_Response * data =
      (ugv_interface__action__Behavior_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ugv_interface__action__Behavior_FeedbackMessage__init(ugv_interface__action__Behavior_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ugv_interface__action__Behavior_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!ugv_interface__action__Behavior_Feedback__init(&msg->feedback)) {
    ugv_interface__action__Behavior_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
ugv_interface__action__Behavior_FeedbackMessage__fini(ugv_interface__action__Behavior_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  ugv_interface__action__Behavior_Feedback__fini(&msg->feedback);
}
...
ugv_interface__action__Behavior_FeedbackMessage__are_equal(const ugv_interface__action__Behavior_FeedbackMessage * lhs, const ugv_interface__action__Behavior_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!ugv_interface__action__Behavior_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_FeedbackMessage * msg = (ugv_interface__action__Behavior_FeedbackMessage *)allocator.allocate(sizeof(ugv_interface__action__Behavior_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__action__Behavior_FeedbackMessage));
  bool success = ugv_interface__action__Behavior_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_FeedbackMessage__Sequence__init(ugv_interface__action__Behavior_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_FeedbackMessage * data = NULL;

  if (size) {
    data = (ugv_interface__action__Behavior_FeedbackMessage *)allocator.zero_allocate(size, sizeof(ugv_interface__action__Behavior_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__action__Behavior_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__action__Behavior_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ugv_interface__action__Behavior_FeedbackMessage__Sequence__fini(ugv_interface__action__Behavior_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__action__Behavior_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__action__Behavior_FeedbackMessage__Sequence * array = (ugv_interface__action__Behavior_FeedbackMessage__Sequence *)allocator.allocate(sizeof(ugv_interface__action__Behavior_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__action__Behavior_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ugv_interface__action__Behavior_FeedbackMessage__Sequence__destroy(ugv_interface__action__Behavior_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__action__Behavior_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ugv_interface__action__Behavior_FeedbackMessage__Sequence__are_equal(const ugv_interface__action__Behavior_FeedbackMessage__Sequence * lhs, const ugv_interface__action__Behavior_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__action__Behavior_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ugv_interface__action__Behavior_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__action__Behavior_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__action__Behavior_FeedbackMessage * data =
      (ugv_interface__action__Behavior_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__action__Behavior_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__action__Behavior_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__action__Behavior_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
