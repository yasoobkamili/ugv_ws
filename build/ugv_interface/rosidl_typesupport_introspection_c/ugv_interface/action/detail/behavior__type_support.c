...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ugv_interface, action, Behavior_SendGoal)() {
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_ugv_interface
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ugv_interface, action, Behavior_GetResult)() {
