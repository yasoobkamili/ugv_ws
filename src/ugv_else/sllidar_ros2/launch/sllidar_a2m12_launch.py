...
def generate_launch_description():
    ...
    frame_id = LaunchConfiguration('frame_id', default='base_lidar_link')
    ...
    return LaunchDescription([
        ...
        # base_footprint_to_laser_tf_node = 
        # Node(
        #     package='tf2_ros',
        #     executable='static_transform_publisher',
        #     name='base_footprint_to_base_laser_ld19',
        #     arguments=['0','0','0','0','0','0','base_link','base_lidar_link']
        # ),
...
#         # Static transform from base_footprint to base_lidar_link
#         Node(
#             package='tf2_ros',
#             executable='static_transform_publisher',
#             name='base_footprint_to_base_laser_ld19',
